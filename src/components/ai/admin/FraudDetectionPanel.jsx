// src/Pages/Landing/Admin/FraudDetection.jsx
...
import { FraudAlertProvider } from '../../../context/FraudAlertContext'; // Import the provider
...
const FraudDetection = () => {
  ...
  return (
    <FraudAlertProvider> {/* Wrap everything with the provider */}
      <div className="space-y-8 p-4 md:p-6">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 shadow-xl overflow-hidden">
          <div className="p-6 md:p-8">
            ...
            {showAIPanel && (
              <div className="mb-8">
                <FraudDetectionPanel /> {/* This now has access to the context */}
              </div>
            )}
