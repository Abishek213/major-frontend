...
// Helper function to get AI feature status for a specific tab
...
// Helper function to get all enabled AI agents for a dashboard
export const getEnabledAIAgents = (dashboardType) => {
  const config = {
    user: userDashboardConfig,
    organizer: organizerDashboardConfig,
    admin: adminDashboardConfig,
...
// Helper function to get AI widgets for a dashboard
export const getAIWidgets = (dashboardType) => {
  const config = {
    user: userDashboardConfig,
    organizer: organizerDashboardConfig,
    admin: adminDashboardConfig,
...
// Helper function to check if experimental feature is enabled
export const isExperimentalFeatureEnabled = (featureKey) => {
  return aiFeatureFlags.experimental[featureKey] ?? false;
};

// Helper function to get AI model configuration
export const getAIModelConfig = (modelType) => {
  const models = {
