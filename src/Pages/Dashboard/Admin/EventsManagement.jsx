...
const EventsManagement = () => {
  ...
  const sortedEvents = [...filteredEvents].sort((a, b) => {
    ...
    if (sortConfig.key === 'organizer') {
      ...
      return sortConfig.direction === 'asc' ? orgA.localeCompare(orgB) : orgB.localeCompare(orgA);
    }
    return 0;
  });
        ...
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="p-8 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 140px)' }}>
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3">{event.event_name}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-gray-900 text-lg">Date & Time</span>
                  </div>
                  <p className="text-gray-700 text-base">{formatDateTime(event.event_date)}</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <p className="text-gray-700 text-base">{event.location || 'Not specified'}</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <p className="text-gray-700 text-base font-semibold">${event.price || '0'}</p>
                </div>

                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-indigo-600" />
                    <span className="font-semibold text-gray-900 text-lg">Capacity</span>
                  </div>
                  <p className="text-gray-700 text-base">{event.totalSlots || 'Unlimited'} slots</p>
                </div>

                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <Clock className="w-6 h-6 text-indigo-600" />
                    <span className="font-semibold text-gray-900 text-lg">Duration</span>
                  </div>
                  <p className="text-gray-700 text-base">{event.duration || 'Not specified'}</p>
                </div>

                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <Globe className="w-6 h-6 text-indigo-600" />
                    <span className="font-semibold text-gray-900 text-lg">Event Type</span>
                  </div>
                  <p className="text-gray-700 text-base capitalize">{event.eventType || 'Physical'}</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-6 border border-orange-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="font-medium text-gray-900 text-lg">{event.organizer?.name || 'Unknown'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Email</p>
                    <p className="font-medium text-gray-900 text-lg">{event.organizer?.email || 'Not provided'}</p>
                  </div>
                  {event.organizer?.phone && (
                    <div>
                      <p className="text-sm text-gray-500 mb-1">Phone</p>
                      <p className="font-medium text-gray-900 text-lg">{event.organizer.phone}</p>
                    </div>
                  )}
                  {event.organizer?.company && (
                    <div>
                      <p className="text-sm text-gray-500 mb-1">Company</p>
                      <p className="font-medium text-gray-900 text-lg">{event.organizer.company}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {event.registrationDeadline && (
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <p className="font-medium text-gray-900 text-lg">{formatDateTime(event.registrationDeadline)}</p>
                  </div>
                )}
                <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <p className="font-medium text-gray-900 text-lg">{formatDateTime(event.createdAt)}</p>
                </div>
                {event.updatedAt && (
                  <div className="bg-gray-50 rounded-xl p-6">
                    <p className="text-sm text-gray-500 mb-2">Last Updated</p>
                    <p className="font-medium text-gray-900 text-lg">{formatDateTime(event.updatedAt)}</p>
                  </div>
                )}
              </div>
            </div>
    ...
    <div className="space-y-8 p-6 md:p-8 bg-gradient-to-br from-gray-50 to-white min-h-screen">
      ...
      {error && (
        <div className="relative p-6 pl-16 bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 rounded-lg shadow-sm animate-fade-in">
          ...
          <div className="pr-12">
            <h4 className="font-bold text-red-800 text-lg mb-1">Action Required</h4>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div className="bg-gradient-to-br from-indigo-50 to-white border border-indigo-100 rounded-xl p-8 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600 font-medium text-lg">Pending Review</p>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-white border border-emerald-100 rounded-xl p-8 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              ...
              <h3 className="text-4xl font-bold text-gray-800 mb-2">{stats.approved}</h3>
              <p className="text-gray-600 font-medium text-lg">Approved</p>
            ...
            <div className="bg-gradient-to-br from-rose-50 to-white border border-rose-100 rounded-xl p-8 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              ...
              <h3 className="text-4xl font-bold text-gray-800 mb-2">{stats.rejected}</h3>
          ...
          {/* Events Table - Larger and More Prominent */}
          <div className="border border-gray-200 rounded-xl overflow-hidden shadow-lg">
            {currentItems.length > 0 ? (
              <>
                        ...
                        >
                          ...
                          <td className="py-6">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-semibold text-gray-900 text-base">{event.organizer?.name || 'Unknown'}</p>
                                <p className="text-sm text-gray-500">
                                  {event.organizer?.email?.length > 25 
                                    ? `${event.organizer.email.substring(0, 25)}...` 
                ...
                <div className="bg-gray-50 px-8 py-5 border-t border-gray-200 flex items-center justify-between">
                  <div className="text-gray-600 text-base">
                    ...
                    of <span className="font-semibold">{sortedEvents.length}</span> events
                  </div>
              ...
              <div className="py-20 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-700 mb-3">No Pending Events</h3>
