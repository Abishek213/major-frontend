  ...
  const milestones = [
    {
      year: '2022',
      title: 'Foundation',
      description: 'e-VENTA was established with a vision to transform event management.',
    },
    {
      year: '2023',
      title: 'Rapid Growth',
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-900 pt-16">
      ...
      <div className="bg-gradient-to-r from-primary to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About e-VENTA</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Welcome to e-VENTA, your premier platform for hosting and attending events. 
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center mb-12 max-w-2xl mx-auto text-gray-600">
            Discover the features that make e-VENTA the perfect platform for your event management needs
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-6 rounded-xl border transition-all duration-300 bg-white border-gray-200 hover:border-blue-500/50 hover:shadow-lg"
              >
