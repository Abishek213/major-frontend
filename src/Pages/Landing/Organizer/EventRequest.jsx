...
const EventRequest = () => {
  ...
  return (
    <div className="space-y-8 p-4 md:p-6 bg-gradient-to-br from-gray-50 to-white min-h-screen">
      ...
      {showCompetitorAnalysis && selectedRequest && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <OfferCompetitorAnalysis 
                requestId={selectedRequest._id}
                currentOffer={proposedBudget[selectedRequest._id]}
              />
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 z-10 flex gap-2">
                    <button
                      onClick={() => handleOpenAIAssistant(request)}
                      className="p-2 rounded-lg bg-purple-500 text-white shadow-lg hover:bg-purple-600 transition-all duration-300 hover:scale-110"
                      title="Open AI Negotiation Assistant"
                    >
                      <Bot className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => handleCompetitorAnalysis(request)}
                      className="p-2 rounded-lg bg-blue-500 text-white shadow-lg hover:bg-blue-600 transition-all duration-300 hover:scale-110"
