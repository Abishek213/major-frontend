...
const EventRequest = () => {
  ...
  const handleAccept = async (eventId, proposedBudgetValue) => {
    try {
              ...
              >
                ...
                <div className="p-6 pt-0">
                  <div className="flex gap-3">
                    <button
                      onClick={() => handleAccept(request._id, proposedBudget[request._id] || "")}
                      className="flex-1 group/accept py-3 rounded-xl font-medium flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white shadow-lg hover:shadow-xl transition-all duration-300"
                    >
